...
$guardarsolicitudcapacitacion = new Controladores\CapacitacionesControlador;
$guardarsolicitudcapacitacion->guardar();
?>
<main class="contenido">
    ...
    <div class="principal1">
        <form id="formRegistroCapacitacion" method="POST" class="caja__der">
                ...
                <div class="contenedor_izq_der">
                    ...
                    <div class="caja__izq">
                        <div class="elemento_individual_form">
                            <label for="tipocapacitacion"><div class="dato_obligatorio"></div>Tipo:</label>
                            <select class="contactoForm_elemento-dimension" name="tipocapacitacion" id="tipocapacitacion" required>
...
<script src="Vistas/js/registrarCapacitacion.js" type="module"></script>
<script src="Vistas/js/apiFetchCapacitaciones.js" type="module"></script>