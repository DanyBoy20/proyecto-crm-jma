<nav id='barraNavegacion' class='navegacion'>
    ...
    <div class='fila--alineacion-v-centro fila--alineacion-h-centro'>
        <ul class='listaNav'>
            ...
            <!-- Empleados -->
            <?php if($_SESSION['idrol'] != 4 && $_SESSION['idrol'] != 5){
            ...
            <!-- Solicitudes -->
            <?php if($_SESSION['idrol'] != 4 && $_SESSION['idrol'] != 6){
                ...
                <li>
                    ...
                    <?php if($_SESSION['idrol'] != 4 && $_SESSION['idrol'] != 5 && $_SESSION['idrol'] != 6){
                    echo "
            ...
            <!-- Soporte -->
            <?php if($_SESSION['idrol'] != 3 && $_SESSION['idrol'] != 6 && $_SESSION['idrol'] != 5){
            echo "
                <li>
                    <div class='listaNav__subencabezado fila fila--alineacion-v-centro'>
            ...
            <?php if($_SESSION['idrol'] != 3 && $_SESSION['idrol'] != 4 && $_SESSION['idrol'] != 5 && $_SESSION['idrol'] != 6){
                echo "
                <li class='listaNav__encabezado'>
