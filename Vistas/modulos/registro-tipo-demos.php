...
$guardarSolicitudDemo->guardarDemo();
?>
    ...
    <div class="principal1">
        <section class="division_secciones">
            <div class="contenedor_izq_der">
                ...
                <!-- INICIO DERECHA -->
                <form id="formRegistroTipoDemo" method="POST" class="caja__der">
                ...
                <fieldset id="seccion__derecha" class="seccion__derecha">
                        ...
                        <div class="contenedor_elementos_fieldset">
                            <div class="elemento_individual_form">
                                <label for="demo"><div class="dato_obligatorio"></div>Nombre:</label>
                                <input type="text" id="demo" name="demo" placeholder="Nombre tipo de demostración" class="contactoForm_elemento-dimension" minlength="10" maxlength="70" required /><span class="avisoError"></span>
                            </div>
...
<script src="Vistas/js/registroTipoSolicitudes.js" type="module"></script>
<script src="Vistas/js/apiFetchRegistroDemos.js" type="module"></script>