...
$guardarSolicitudDemo->guardarMarca();
?>
    ...
    <div class="principal1">
        <section class="division_secciones">
            <div class="contenedor_izq_der">
                ...
                <!-- FIN IZQUIERDA -->
                <!-- INICIO DERECHA -->
                <form id="formRegistroMarcas" method="POST" class="caja__der">
                    <fieldset id="seccion__derecha" class="seccion__derecha">
                        ...
                        <div class="contenedor_elementos_fieldset">
                            <div class="elemento_individual_form">
                                ...
                                <input type="text" id="marca" name="marca" placeholder="Escriba el nombre de la marca" class="contactoForm_elemento-dimension" minlength="10" maxlength="70" required /><span class="avisoError"></span>
                            </div>
...
<script src="Vistas/js/registrarMarcas.js" type="module"></script>
<script src="Vistas/js/apiFetchTablaMarcas.js" type="module"></script>