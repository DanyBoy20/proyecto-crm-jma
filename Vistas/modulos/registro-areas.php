...
$guardarSolicitudDemo = new Controladores\AreasControlador;
                ...
                <fieldset id="seccion__derecha" class="seccion__derecha">
                        ...
                        <div class="contenedor_elementos_fieldset">
                            <div class="elemento_individual_form">
                                ...
                                <input type="text" id="area" name="area" placeholder="Escriba el nombre del area" class="contactoForm_elemento-dimension" minlength="10" maxlength="70" required /><span class="avisoError"></span>
                            </div>
...
<script src="Vistas/js/registrarAreas.js" type="module"></script>
<script src="Vistas/js/apiFetchRegistroAreas.js" type="module"></script>