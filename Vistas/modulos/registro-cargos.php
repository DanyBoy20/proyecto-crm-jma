...
$guardarSolicitudDemo->guardarCargo();
?>
    ...
    <div class="principal1">
        <section class="division_secciones">
            <div class="contenedor_izq_der">
                ...
                <!-- INICIO DERECHA -->
                <form id="formRegistroArea" method="POST" class="caja__der">
                ...
                <fieldset id="seccion__derecha" class="seccion__derecha">
                        ...
                        <div class="contenedor_elementos_fieldset">
                            <div class="elemento_individual_form">
                                <label for="cargo"><div class="dato_obligatorio"></div>Descripcion:</label>
                                <input type="text" id="cargo" name="cargo" placeholder="Nombre del cargo" class="contactoForm_elemento-dimension" minlength="10" maxlength="70" required /><span class="avisoError"></span>
                            </div>
...
<script src="Vistas/js/registrarCargos.js" type="module"></script>
<script src="Vistas/js/apiFetchRegistroCargos.js" type="module"></script>