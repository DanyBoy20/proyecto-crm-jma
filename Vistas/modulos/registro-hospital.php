...
$guardarUsuario = new Controladores\HospitalesControlador;
        ...
        <section class="division_secciones">
            <div class="contenedor_izq_der">
              ...
              -->
                <!-- FIN IZQUIERDA -->
                <!-- INICIO DERECHA -->
                <form id="formRegistroEmpleado" method="POST" class="caja__der">

                    <fieldset id="seccion__izquierda" class="seccion__izquierda">
                        <p class="titulo__fieldset">Datos hospital</p>
                        <div class="contenedor_elementos_fieldset">
                            <div class="elemento_individual_form">
                                ...
                                <input type="text" id="nombre" name="nombre" placeholder="Escriba el/los nombres" class="contactoForm_elemento-dimension" minlength="4" maxlength="50" required /><span class="avisoError"></span>                            
                            </div>
                            <div class="elemento_individual_form">
                                <label for="tipohospital"><div class="dato_obligatorio"></div>Tipo</label>
                                <select class="contactoForm_elemento-dimension" name="tipohospital" id="tipohospital" required>
                                    <option value="undefined" disabled selected hidden>Seleccione tipo</option>
                                    <option value="Privado">Privado</option>
                                    <option value="Publico">Publico</option>
                                </select><span class="avisoError"></span>
                            </div>                            
                            <div class="elemento_individual_form">
                                <label for="telefono"><div class="dato_obligatorio"></div>Teléfono</label>
...
<script src="Vistas/js/registrarHospital.js" type="module"></script>
